...
interface CardImage {
  ...
  const natureTheme: ThemeData = {
    ...
    cardBack: "https://images.unsplash.com/photo-1465146344425-f00d5f5c8f07?q=80&w=200",
    cardImages: [
      { id: 1, image: "https://images.unsplash.com/photo-1472396961693-142e6e269027?q=80&w=200" },
      { id: 2, image: "https://images.unsplash.com/photo-1465146344425-f00d5f5c8f07?q=80&w=200" },
  ...
  const spaceTheme: ThemeData = {
    ...
    cardBack: "https://images.unsplash.com/photo-1470813740244-df37b8c1edcb?q=80&w=200",
    cardImages: [
      { id: 1, image: "https://images.unsplash.com/photo-1470813740244-df37b8c1edcb?q=80&w=200" },
  ...
  const techTheme: ThemeData = {
    ...
    cardBack: "https://images.unsplash.com/photo-1518770660439-4636190af475?q=80&w=200",
    cardImages: [
      ...
      { id: 9, image: "https://images.unsplash.com/photo-1518770660439-4636190af475?q=80&w=200" },
